        ...
        util.ajaxFun('/login/login', 'GET', {
            ...
            if (res.rtnCode === "0000000") {
                ...
                if (isWeiXin()) {
                    ...
                    var rUrl = 'https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx552f3800df25e964&redirect_uri=http://zgkser.zhigaokao.cn/'+ toUrl +'&token=' + token + '&response_type=code&scope=snsapi_base&state=' + $.trim(userKey) + '#wechat_redirect';
